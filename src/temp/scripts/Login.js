...
var Authentication = function () {
   function Authentication() {
      ...
      this.inputPassword = (0, _jquery2.default)('#inputPassword');
      this.inputName = (0, _jquery2.default)('#inputUsername');
      this.inputEmail = (0, _jquery2.default)('#inputEmail');
      this.formAuth = (0, _jquery2.default)('.form-auth');
      this.formReactivation = (0, _jquery2.default)('.form-reactivation');
      this.buttonLogin = (0, _jquery2.default)('#buttonLogin');
      this.formInput = (0, _jquery2.default)('.form-login__input');
      this.formInputGroup = (0, _jquery2.default)('.form-login__input-group');
      this.formCheckbox = (0, _jquery2.default)('.form-login__input-checkbox');
      this.formMessage = (0, _jquery2.default)('.feedback');
      ...
      this.buttonPeek = (0, _jquery2.default)('#buttonPeek');
      this.iconEyeClose = (0, _jquery2.default)('.icon-eye-off');
      this.iconEyeOpen = (0, _jquery2.default)('.icon-eye-on');
   ...
   _createClass(Authentication, [{
      ...
      value: function events() {
         ...
         this.buttonPeek.on('mousedown touchstart', this.showPassword.bind(this)).bind('mouseup mouseleave touchend', this.hidePassword.bind(this));
      }
   }, {
      key: 'buttonInitialDisabled',
      value: function buttonInitialDisabled() {
         this.buttonLogin.prop('disabled', true);
      }
   }, {
      key: 'createButtonPeek',
      value: function createButtonPeek() {
